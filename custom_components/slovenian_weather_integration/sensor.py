...
from .agro import fetch_agro_data, ArsoAgroSensor, normalize_location as normalize_agro_location, AGRO_STATION_MAPPING
...
async def async_setup_entry(
    ...
    if location and agro_data:
        ...
        if matched_station:
            ...
            entities.append(ArsoAgroSensor(hass, matched_station, agro_data))
        else:
