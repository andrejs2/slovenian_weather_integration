...
### Air Quality -- Decluttering Template for Multiple Stations

Using [decluttering-card](https://github.com/custom-cards/decluttering-card), you can create a reusable template:

```yaml
# In decluttering_templates (configuration.yaml or dashboard raw config)
...
Then use it in a horizontal stack for multiple stations:

```yaml
type: horizontal-stack
cards:
  - type: custom:decluttering-card
    template: air_quality_tile
    variables:
      - entity: sensor.arso_kakovost_zraka_ljubljana_bezigrad_eaqi
      - name: Ljubljana
  - type: custom:decluttering-card
    template: air_quality_tile
    variables:
      - entity: sensor.arso_kakovost_zraka_maribor_titova_eaqi
      - name: Maribor
  - type: custom:decluttering-card
    template: air_quality_tile
    variables:
      - entity: sensor.arso_kakovost_zraka_celje_bolnica_eaqi
      - name: Celje
```
